...
function showAll(){
	...
	if (anObj.readyState == 4 && anObj.status == 200) { 
		...
		var str="<div class=\"loginField\" id=\"tochange\">";
		str+=  "<h1>Shipping Information</h1>";
		str+="<form action=\"controller.php\" method=\"GET\">";
		for(var i=0;i<array.length;i++){
			str+="First Name:&nbsp;";
			if( array[i]['fname'] === null)
				str+="<input name=\"firstName\"  type=\"text\" id=\"firstname\" value=\"\""+ "placeholder=\"Not Provided\"" + " required><br><br>";
			else	
				str+="<input name=\"firstName\"  type=\"text\" id=\"firstname\" value=\""+  array[i]['fname']+"\" required><br><br>";

			
		    str+="Last Name:&nbsp;";
		    if( array[i]['lname'] === null)
		    	str+="<input name=\"lastName\" pattern=\"[A-Z a-z]*\" type=\"text\" id=\"lastname\" value=\"\"" + "placeholder=\"Not Provided\"" + " required><br><br>";
		    else
		    	str+="<input name=\"lastName\" pattern=\"[A-Z a-z]*\" type=\"text\" id=\"lastname\" value=\""+array[i]['lname'] +"\" required><br><br>";
			str+="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";

			if(array[i]['street'] === null)
				str+="Street:&nbsp; <input name=\"street\" type=\"text\" id=\"street\" value=\"\"" + "placeholder=\"Not Provided\"" + " required><br><br>";
			else
				str+="Street <input name=\"street\" type=\"text\" id=\"street\" value=\""+ array[i]['street']+ "\" required><br><br>";
			str+="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";

			if(array[i]['city'] === null)
				str+="City:&nbsp; <input name=\"city\" pattern=\"[A-Z a-z]*\" type=\"text\" id=\"city\" value=\"\"" + "placeholder=\"Not Provided\"" + " required><br><br>";
			else
			...
			if(array[i]['zip'] === null)
				str+="ZIP <input name=\"zip\" pattern=\"[0-9]{5}\" type=\"text\" id=\"zip\" value=\"\""+"placeholder=\"Not Provided\""+" required>";
			else
				str+="ZIP <input name=\"zip\" pattern=\"[0-9]{5}\" type=\"text\" id=\"zip\" value=\""+array[i]['zip']+"\" required>";
				
		    str+="<br><br><input type=\"submit\" name=\"continueButton\" value=\"Continue\"></form>";
		    str+="<a href=\"index.php\">Back to Home</a>"
		    str+="</div>";
	}
