...
function showAll()
{
	...
	if (anObj.readyState == 4 && anObj.status == 200) { 
		...
		if(array.length==0){
			...
			str+="<div style=\" float:left; margin-left:30px; margin-top:30px;\">Total: $" + total + "</div>";
			str+="<form style=\"float:left; margin-left:30px; margin-top:25px;\" action=\"checkout.php\"><input type=\"submit\" value=\"Check Out\"></form>";
